...
//    public MyOnClickListener myOnClickListener;
    ...
    public ProductTypeAdapter(List<ProductType> productTypeList, Context context) {
    ...
    @NonNull
    @Override
    public ProductTypeAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull ProductTypeAdapter.MyViewHolder holder, int position) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Log.e("CATEGORY","QAYSI ID  "+ productType.getProductTypeId());
